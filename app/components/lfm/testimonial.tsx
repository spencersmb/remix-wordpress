  ...
  return (
    <>
      <div className="lfm-testimonial lfm-testimonial--alt et-grid-basic z-3 gap-x-0 grid-rows-[auto_minmax(50px,50px)_auto_auto] py-20 relative laptop:overflow-visible laptop:grid-rows-[auto]">
        ...
        {/* BG COLOR BLOCK */}
        <div
          data-testid='lfm-testimonial-bg'
        ...
        {/* TESTIMONIAL PROFILE */}
        <div
          data-testid='lfm-testimonial-profileContainer'
          className={classNames(makerCss, 'relative col-span-2 col-start-2 row-start-1 pt-6 mx-auto lfm-testimonial__maker tablet:col-start-3 tablet:col-span-10 laptop:pt-6 laptop:px-6 laptop:pb-6 laptop:row-span-2 laptop:row-start-1 desktop:mb-8')}>
          ...
          <blockquote
            data-testid='lfm-testimonial-blockquote'
            className='text-lfm-blue-700 text-center font-sentinel__SemiBoldItal text-2xl max-w-[457px] mx-[-5px] mb-5 py-3 tablet:mx-auto tablet:mb-5 tablet:py-3 tablet:px-8 laptop:text-3xl laptop:max-w-none'>
            “{testimonial.pullQuote}”
          </blockquote>

          <p
            data-testid='lfm-testimonial-quote'
            className='text-lg text-lfm-blue-700 desktop:text-xl'>{testimonial.quote}</p>
        </div>

        {/* FONT CARD - lfm-testimonial__font */}
        <div
          data-testid='lfm-testimonial-imgContainer'
          className={classNames(fontContainerCss, 'col-span-2 col-start-2 row-span-2 row-start-3 mt-20 lfm-testimonial__font tablet:mt-12 tablet:col-start-3 tablet:col-span-10 laptop:row-start-1 laptop:row-span-3 laptop:flex laptop:items-center')}>
          ...
          <div className="lfm-testimonial__fontHeroWrapper w-full relative max-w-[370px] mx-auto min-h-[254.25px] tablet:min-h-[255px] desktop:max-w-none desktop:min-h-[401.47px] desktop:w-full">
            ...
            <div className="lfm-testimonial__fontCreator relative z-3 w-full max-w-[557px] ml-auto desktop:max-w-[697px]">
              ...
              {fontLoadingStatus === 'completed' &&
                <p
                  data-testid='lfm-testimonial-font-creator'
                  className={classNames(authorNameCss, 'absolute left-[50px] top-[-70px] skinnyJeans text-2xl text-[#333F4F] rotate-[-5deg] mt-0 laptop:text-3xl')}>
            ...
            <div className="lfm-testimonial__scribble max-w-[200px] absolute bottom-[-70px] left-[140px] rotate-[120deg] z-2 min-h-[277.71px] w-full desktop:bottom-[-169px] desktop:w-[350px] desktop:rotate-[130deg] desktop:min-h-[503.25px] desktop:max-w-none desktop:left-[230px]">
              <LazyImgix
                ...
                image={{
                  ...
                  alt: "Every-Tuesday Scribble texture made with Procreate",
                  height: staticImages.scribbles.stroke_2.height,
                  width: staticImages.scribbles.stroke_2.width,
                  placeholder: staticImages.scribbles.stroke_2.placeholder,
                }}
              />
