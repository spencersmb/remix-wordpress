...
function ColorSwatches(props: Props) {
  ...
  return (
    <div className="relative items-center px-4 tablet:flex-auto laptop:mr-0">
      <div className={`bg-white text-white relative rounded-2.5xl overflow-hidden px-[45px] py-[30px] shadow-xs tablet:py-[52px] laptop:mb-0 ${multipleLayout ? cssMultipleContainer : cssSingleContainer}`}>
