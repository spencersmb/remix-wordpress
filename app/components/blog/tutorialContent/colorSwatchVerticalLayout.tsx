...
function ColorSwatchesVerticalLayout(props: Props) {
  ...
  return (
    <div className={`bg-white text-white relative rounded-2.5xl overflow-hidden px-[45px] py-[30px] shadow-xs flex items-center tablet:py-[52px] laptop:mb-0 ${cssSingleContainer}`}>
      <div className={`swatch_content relative max-w-[300px] flex flex-col z-10 tablet:mt-0 tablet:mr-44 ${'mt-52 laptop:mr-4'}`}>
      ...
      <div className={`swatch_img w-full max-w-400px top-[-80px] right-[0px] left-auto absolute z-0 tablet:top-auto tablet:bottom-0 tablet:right-[-350px] ${''}`}>
