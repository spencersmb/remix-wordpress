...
function CourseHeader() {
  ...
  return (
    <div className='grid grid-flow-row grid-rows-[auto_auto_minmax(60px,auto)_auto] text-white grid-cols-mobile gap-x-5 tablet:grid-cols-tablet tablet:gap-x-5 desktop:grid-cols-desktop desktop:grid-rows-[auto_auto_minmax(120px,auto)_auto]'>
      ...
      <div className={`${navStyles} relative col-span-2 col-start-2 row-start-1 mt-8 mb-2 z-2 tablet:col-start-2 tablet:col-span-4 tablet:mt-14 desktop:mt-20 desktop:mb-4 desktop:text-xl`}>Online Courses</div>

      <div className='relative col-span-2 col-start-2 row-start-2 mb-8 z-2 tablet:col-start-2 tablet:col-span-9 tablet:mb-12 laptop:col-start-2 laptop:col-span-9 desktop:mb-20 desktop:col-start-2 desktop:col-span-10 desktopXl:col-start-2 desktopXl:col-span-9'>
        <div className='text-3xl font-sentinel__SemiBoldItal tablet:text-4xl desktop:text-6xl '>
          I love sharing what I’ve learned over my career and motivating others to create something new every week.
        </div>
      </div>

      <div className='relative col-span-2 col-start-2 row-span-2 row-start-3 image z-2 tablet:col-start-2 tablet:col-span-7 tablet:px-8 laptop:col-start-3 laptop:col-span-6 laptop:ml-[-30px] desktop:col-start-2 desktop:col-span-6 desktop:pl-16 desktop:pr-0 max-w-[550px] desktop:mr-0 desktop:ml-auto w-full'>

        <div className='rotate-3'>
          <PolaroidImg

            imgixImage={teela.image}
            imgOptions={{
      ...
      <div className='col-span-2 col-start-2 row-start-5 mt-12 text-sage-800 tablet:col-start-9 tablet:col-span-5 tablet:row-start-4 tablet:mt-6 tablet:ml-[-30px] laptop:col-start-9 laptop:col-span-5 laptop:justify-center laptop:flex laptop:flex-col laptop:mt-0 desktop:col-start-8 desktop:ml-[30px] desktop:col-span-5'>
      ...
      <div className='relative row-span-3 row-start-1 overflow-hidden bg-emerald-800 col-span-full z-1'>
