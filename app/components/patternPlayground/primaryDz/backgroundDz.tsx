...
const BackgroundDz = ({ patternState }: any) => {
  ...
  return (
    <div className='relative'>
      ...
      <Dropzone
        ...
        classNames={{
          dropzone: 'upload transition-all duration-300 ease-in-out w-full',
        }}
        ...
        styles={{
          dropzone: { minHeight: 600, maxHeight: 1250, height: 'calc(100vh - var(--nav-top-lg))', overflow: 'hidden', position: 'relative' },
