...
function ProcreateBrushes() {
  ...
  return (
    <section className='et-grid-basic overflow-hidden tablet:grid-row-[auto_auto]'>
      ...
      {/* IMAGE 1 */}
      <div className='relative col-span-2 col-start-2 h-[350px] mt-8 tablet:col-start-2 tablet:col-span-8 tablet:row-start-2 tablet:h-[200px] laptop:mt-16 desktop:h-[350px]'>
      ...
      {/* IMAGE 2 */}
      <div className='hidden relative col-span-2 col-start-2 h-[350px] mt-8 tablet:col-start-10 tablet:col-span-4 tablet:row-start-2 tablet:h-[200px] tablet:block laptop:mt-16 desktop:h-[350px]'>
      ...
      {/* CONTENT */}
      <div className='flex flex-col items-start col-span-2 col-start-2 py-8 tablet:row-start-1 tablet:col-start-3 tablet:col-span-6 tablet:mt-32 desktop:col-start-3 desktop:col-span-5'>
