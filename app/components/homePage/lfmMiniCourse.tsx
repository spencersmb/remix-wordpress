...
function LfmMiniCourse(props: Props) {
  ...
  return (
    <section className='relative flex bg-grey-200 tablet:p-0 et-grid-basic'>
      ...
      {/* CARD CONTENT */}
      <div className='relative flex flex-col col-span-2 col-start-2 gap-6 p-6 mb-8 text-center bg-white z-2 mt-60 tablet:col-start-4 tablet:col-span-8 tablet:row-start-1 tablet:my-16 tablet:self-center tablet:pb-10 laptop:col-start-8 laptop:col-span-5 max-w-[433px] mx-auto laptop:items-center'>
        ...
        {/* TITLE */}
        <div className='max-w-[270px] mx-auto relative text-5xl font-sentinel__SemiBoldItal text-grey-800 desktop:text-6xl pt-4'>
          Free Font Making
        ...
        {!isClassOpen && <Link to={'/learn-font-making'} className={'mt-3 btn btn-primary btn-primary-ring btn-xl'} prefetch={'intent'}>
          View Mini Course
        </Link>}
      </div>
