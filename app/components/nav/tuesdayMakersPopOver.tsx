...
function IconTwo() {
  return (
    <svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.1665 26.9165L18.9998 34.8332L34.8332 26.9165" stroke="#C7D8D8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M3.1665 19L18.9998 26.9167L34.8332 19" stroke="#8FB1B1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M18.9998 3.16675L3.1665 11.0834L18.9998 19.0001L34.8332 11.0834L18.9998 3.16675Z" stroke="#4F7171" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
