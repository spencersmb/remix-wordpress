...
import video1 from "../mini-course/video-1"
const title = 'How to Vectorize Lettering for Font Making'
const description = 'Over the last year and a half, I’ve had the opportunity to teach the basics of typography to undergraduate graphic design students. During this time, I’ve noticed some common mistakes that my students make when first learning how to work with type.'
const pageMeta = {
  title,
