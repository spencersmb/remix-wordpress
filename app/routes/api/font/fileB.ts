...
import { createAlphabetImages, createFontTitle, createNumberImages, createUpperLowercaseImages, fontAssets, registeredFonts } from "~/server/fonts/fontPreviewUtils.server";
...
export let loader: LoaderFunction = async({request, params}) => {
  ...
  // const font = fontAssets[fontSlug]
  ...
  // registerFont(`./${skinnyJeansCaps}`, { family: 'skinny-caps', weight: 'bold', style:"caps" })
  // let fontImages: any = {}
