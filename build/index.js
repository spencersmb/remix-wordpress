...
var SiteContext = (0, import_react.createContext)({
  state: siteInitialState,
  dispatch: () => null
});
SiteContext.displayName = "SiteContext";
var useSiteContext = () => {
  const context = (0, import_react.useContext)(SiteContext);
  if (!context) {
...
// app/utils/windowUtils.ts
var consoleHelper = (data, obj = null) => {
  if (process.env.NODE_ENV === "production")
    return;
  obj ? console.log(data, obj) : console.log(data);
};

// app/hooks/useSite/useSiteReducer.ts
var ISiteTypes;
(function(ISiteTypes2) {
  ISiteTypes2["ADD_POSTS"] = "ADD_POSTS";
  ISiteTypes2["LOGOUT"] = "LOGOUT";
  ISiteTypes2["MODAL_OPEN"] = "MODAL_OPEN";
  ISiteTypes2["MODAL_CLOSE"] = "MODAL_CLOSE";
})(ISiteTypes || (ISiteTypes = {}));
var useSiteReducer = (state, action6) => {
  consoleHelper("site reducer action", action6);
  switch (action6.type) {
...
// app/hooks/useSite/useSiteProvider.tsx
var import_react2 = __toModule(require("react"));
var UseSiteProvider = ({ children, defaultState }) => {
  const [state, dispatch] = (0, import_react2.useReducer)(useSiteReducer, defaultState);
  const value = { state, dispatch };
  return /* @__PURE__ */ React.createElement(SiteContext.Provider, {
    value
  }, children);
};
var useSiteProvider_default = UseSiteProvider;

// app/hooks/useFetchPagination/useFetchPaginateProvider.tsx
var import_react4 = __toModule(require("react"));

// app/hooks/useFetchPagination/index.ts
var import_react3 = __toModule(require("react"));

// app/hooks/useFetchPagination/useFetchPaginationReducer.ts
var IFetchPaginateTypes;
(function(IFetchPaginateTypes2) {
  IFetchPaginateTypes2["ADD_POSTS"] = "ADD_POSTS";
  IFetchPaginateTypes2["LOADING"] = "LOADING";
})(IFetchPaginateTypes || (IFetchPaginateTypes = {}));
var useFetchPaginationReducer = (state, action6) => {
  consoleHelper("fetch pagination reducer action", action6);
  switch (action6.type) {
    case IFetchPaginateTypes.ADD_POSTS:
      return __spreadProps(__spreadValues(__spreadValues({}, state), action6.payload), {
        loading: false
      });
...
var useFetchPagination_default = useFetchPaginate;

// app/hooks/useFetchPagination/useFetchPaginateProvider.tsx
var UseFetchPaginateProvider = ({ children, defaultState }) => {
  const [state, dispatch] = (0, import_react4.useReducer)(useFetchPaginationReducer, defaultState ? defaultState : fetchInitialState);
  const value = { state, dispatch };
  return /* @__PURE__ */ React.createElement(FetchPaginateContext.Provider, {
    value
  }, children);
};
var useFetchPaginateProvider_default = UseFetchPaginateProvider;
...
function App() {
  ...
  let selectedMatch = matches.find((match) => {
    var _a2;
    return (_a2 = match.data) == null ? void 0 : _a2.pageInfo;
  });
  const posts = selectedMatch ? (_a = selectedMatch == null ? void 0 : selectedMatch.data) == null ? void 0 : _a.posts : null;
  const pageInfo = selectedMatch ? (_b = selectedMatch == null ? void 0 : selectedMatch.data) == null ? void 0 : _b.pageInfo : null;
  let defaultState = posts && pageInfo ? {
    page: 1,
  ...
  return /* @__PURE__ */ React2.createElement(useSiteProvider_default, {
    defaultState: value
  }, /* @__PURE__ */ React2.createElement(useFetchPaginateProvider_default, {
    defaultState
...
var PrimaryNav = () => {
  const { state: { menu, user } } = useSite_default();
...
var import_test_utils = __toModule(require("react-dom/test-utils"));
var input = import_test_utils.Simulate.input;
...
function Index2() {
  ...
  const { state, addPostsAction, loadingPosts } = useFetchPagination_default();
  let stateSource = state.posts.length > 0 ? state : {
    posts: data.posts,
    page: 1,
...
`
  ...
  async function fetchMore() {
    loadingPosts();
    const url = window.ENV.PUBLIC_WP_API_URL;
    const variables = {
    ...
    const { data: data2 } = await body.json();
    const filteredPosts = flattenAllPosts(data2.posts) || [];
    addPostsAction({
      page: stateSource.page + 1,
      endCursor: data2.posts.pageInfo.endCursor,
      hasNextPage: data2.posts.pageInfo.hasNextPage,
      posts: [
        ...stateSource.posts,
        ...filteredPosts
      ]
  ...
  return /* @__PURE__ */ React.createElement(Layout2, null, /* @__PURE__ */ React.createElement("div", {
    ...
    to: demo.to,
    prefetch: "intent"
  }, demo.name)))), /* @__PURE__ */ React.createElement("h2", null, "Resources"), /* @__PURE__ */ React.createElement("ul", null, stateSource.posts.map((post) => /* @__PURE__ */ React.createElement("li", {
    key: post.id,
    className: "remix__page__resource"
  }, /* @__PURE__ */ React.createElement(import_remix24.Link, {
    to: post.slug,
    ...
    onClick: fetchMore
  }, stateSource.loading ? "Loading..." : "Fetch More"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("button", {
    onClick: fetchGraphCDN
  }, "Clear Graph")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("button", {
    onClick: checkCache
  }, "checkCache")))));
}
var query2 = `
